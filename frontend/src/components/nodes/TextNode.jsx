  ...
  return (
    <NodeContainer title="Text Input" icon={Type} isSelected={selected} nodeId={id}>
      <div className="flex flex-col gap-2">
        ...
        <textarea 
          className="w-full text-sm p-2 bg-gray-50 border border-gray-200 rounded-md focus:bg-white focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-none nodrag" 
          rows="3" 
